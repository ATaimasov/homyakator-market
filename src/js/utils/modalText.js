...
export const fancyText = {
  ...
  <img src="/img/successSend.gif" alt="tracking hamster" class=" toaser__image header__cart-bag-toaster-image modal-message__img">
  <p class="modal-message__text">We will contact you soon!</>
  </div>
  `,
  requiredFields: `<p class="modal-text">Fill in the mandatory fields</p>`,
  errorSend     : `
  <div class="modal-message">
  <img src="/img/errorSend.png" alt="sad hamster" class=" toaser__image header__cart-bag-toaster-image modal-message__img">
  <p class="modal-message__text">Oops! Something went wrong</>
  </div>
  `,
  technicalWork: `
  <div class="modal-message">
...
const operatorName = '<span >Таймасов&nbsp;А.&nbsp;Ю.</span>',
      siteName     = '<span class="modal__domain">homyakator.таймасов.рф</span>',
      operatorMail = '<span>info@таймасов.рф</span>';


export const fancyTextLaw = {
  terms: `
    <div class="modal">
          <div class="modal__wrapper">
            <div class="modal__header">
              Условия предоставления услуг интернет-магазина "Хомякатор"
            </div>
    
            <div class="modal__paragraph">
            <div class="modal__title">1. Общие положения</div>
              <ul class="modal__items">
                <li class="modal__item">
                  1.1. Интернет-магазин "Хомякатор" (далее - Магазин) предоставляет услуги по продаже корма, еды и сопутствующих товаров исключительно для хомяков (далее - Покупателей).
                </li>
    
                <li class="modal__item">
                  1.2. Посетителем сайта Магазина может быть только хомяк. Людям вход воспрещен. Если вы являетесь человеком - покиньте страницу.
                </li>
                <li class="modal__item">
                  1.3. Настоящие условия предоставления услуг (далее - Условия) регулируют порядок использования Магазина, покупки товаров, а также права и обязанности Покупателей.
                </li>
              </ul>
            </div>
    
            <div class="modal__paragraph">
              <div class="modal__title">2. Ассортимент товаров</div>
              <ul class="modal__items">
                <li class="modal__item">
                  2.1. Магазин предлагает широкий ассортимент еды для хомяков, включая сухой корм, готовые сеты и другие продукты. Вам точно хватит за обе щеки.
                </li>
    
                <li class="modal__item">
                  2.2. Все товары, представленные в Магазине, соответствуют стандартам хомячиного качества и безопасности.
                </li>
               ...
               <div class="modal__paragraph">
              <div class="modal__title">3. Оформление заказа</div>
              <ul class="modal__items">
                <li class="modal__item">
                  3.1. Для оформления заказа Покупателю необходимо выбрать интересующие товары и добавить их в корзину.
                </li>
    
                <li class="modal__item">
                  3.2. После завершения выбора товаров Покупатель должен указать указать свои контактные данные в контактной форме.
                </li>
                <li class="modal__item">
                  3.3. После этого, Магазину передается информация о заказе и контактных данных покупателя для связи
                </li>
                  </ul>
              </div>       
              
              <div class="modal__paragraph">
              <div class="modal__title">4. Доставка</div>
              <ul class="modal__items">
                <li class="modal__item">
                  4.1. Магазин осуществляет доставку в любой регион Хомячиной Федерации.
                </li>
                  </ul>
              </div>    

              <div class="modal__paragraph">
              <div class="modal__title">5. Оплата</div>
              <ul class="modal__items">
                <li class="modal__item">
                  5.1. Оплата товаров производится при получении.
                </li>
                  </ul>
              </div>      

              <div class="modal__paragraph">
              <div class="modal__title">6. Скидки и акции</div>
              <ul class="modal__items">
                <li class="modal__item">
                  6.1. Пожилым грызунам (старше 2 лет) предоставляется скидка 10% на весь ассортимент.
                </li>
                  </ul>
              </div>   

              <div class="modal__paragraph">
              <div class="modal__title">7. Очень важные положения</div>
              <ul class="modal__items">
                <li class="modal__item">
                  7.1. Данное положение не является публичной офертой.
                </li>
                <li class="modal__item">
                  7.2. <span class="modal__warning">Данный интернет-магазин не является настоящим. Это ПЕТ-проект, созданный в учебных и развлекательных целях.</span>
                </li>
                <li class="modal__item">
                  7.3. <a href="https://github.com/ATaimasov/Homyakator-market" class="modal__link" target="_blank">Ссылка на проект в GitHub</a>
                </li>
                  </ul>
              </div>   

              <div class="modal__paragraph">
              <div class="modal__title">8. Контактные данные </div>
              <ul class="modal__items">
                <li class="modal__item">
                ...
                <li class="modal__item">
                  8.3. Написать в телеграмм: <a href="https://t.me/ATaimasov" class="modal__link" target="_blank">@ATaimasov</a> 
                </li>
                  </ul>
              </div>       
         `,

    policy: `<div class="modal">
          <div class="modal__wrapper">
            <div class="modal__header">
            ...
            <div class="modal__paragraph">
              ...
              <div class="modal__descr">
                ...
                предпринимаемые ${operatorName} (далее&nbsp;&mdash;
                Оператор).
              </div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">2. Основные понятия, используемые в&nbsp;Политике</div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">3. Основные права и&nbsp;обязанности Оператора</div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              ...
              <ul class="modal__items">
                <li class="modal__item">5.1. Фамилия, имя, отчество.</li>
                <li class="modal__item">5.2. Электронный адрес.</li>
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">6. Принципы обработки персональных данных</div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">7. Цели обработки персональных данных</div>
              <ul class="modal__items">
                <li class="modal__item">
                ...
                <li class="modal__item">
                  ...
                  ${operatorMail} с&nbsp;пометкой &laquo;Отказ
            ...
            <div class="modal__paragraph">
              ...
              <ul class="modal__items">
                ...
                <li class="modal__item">
                  ...
                  формы, расположенные на&nbsp;сайте ${siteName} или
            ...
            <div class="modal__paragraph">
              <div class="modal__title">9. Условия обработки персональных данных</div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              ...
              <ul class="modal__items">
                ...
                <li class="modal__item">
                  ...
                  ${operatorMail} с&nbsp;пометкой &laquo;Актуализация
                ...
                <li class="modal__item">
                  ...
                  почты на&nbsp;электронный адрес Оператора ${operatorMail}
            ...
            <div class="modal__paragraph">
              <div class="modal__title">12. Трансграничная передача персональных данных</div>
              <ul class="modal__items">
                <li class="modal__item">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">13. Конфиденциальность персональных данных</div>
              <div class="modal__descr">
            ...
            <div class="modal__paragraph">
              <div class="modal__title">14. Заключительные положения</div>
              <ul class="modal__items">
                <li class="modal__item">
