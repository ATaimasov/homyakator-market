...
export const fancyText = {
  ...
  <img src="/img/successSend.gif" alt="tracking hamster" class=" toaser__image header__cart-bag-toaster-image popUp-message__img">
  <p class="popUp-message__text">We will contact you soon!</>
  </div>
  `,
  requiredFields: `<p class="popup-text">Fill in the mandatory fields</p>`,
  errorSend     : `
  <div class="popUp-message">
  <img src="/img/errorSend.png" alt="sad hamster" class=" toaser__image header__cart-bag-toaster-image popUp-message__img">
  <p class="popUp-message__text">Oops! Something went wrong</>
  </div>
  `,
  technicalWork: `
  <div class="popUp-message">
  ...
  terms: `
    <div class="popUp">
          <div class="popUp__wrapper">
            ...
            <div class="popUp__title">1. Общие положения</div>
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">2. Ассортимент товаров</div>
              <ul class="popUp__items">
                <li class="popUp__item">
               ...
               <div class="popUp__paragraph">
              <div class="popUp__title">3. Оформление заказа</div>
              <ul class="popUp__items">
                <li class="popUp__item">
              ...
              <div class="popUp__paragraph">
              <div class="popUp__title">4. Доставка</div>
              <ul class="popUp__items">
                <li class="popUp__item">
              ...
              <div class="popUp__paragraph">
              <div class="popUp__title">5. Оплата</div>
              <ul class="popUp__items">
                <li class="popUp__item">
              ...
              <div class="popUp__paragraph">
              <div class="popUp__title">6. Скидки и акции</div>
              <ul class="popUp__items">
                <li class="popUp__item">
              ...
              <div class="popUp__paragraph">
              <div class="popUp__title">7. Очень важные положения</div>
              <ul class="popUp__items">
                <li class="popUp__item">
                  7.1. Данное положение не является публичной офертой.
                </li>
                <li class="popUp__item">
                  7.2. <span class="popUp__warning">Данный интернет-магазин не является настоящим. Это ПЕТ-проект, созданный в учебных и развлекательных целях.</span>
                </li>
                <li class="popUp__item">
                  7.3. <a href="https://github.com/ATaimasov/Homyakator-market" class="popUp__link" target="_blank">Ссылка на проект в GitHub</a>
                </li>
                  </ul>
              </div>   

              <div class="popUp__paragraph">
              <div class="popUp__title">8. Контактные данные </div>
              <ul class="popUp__items">
                <li class="popUp__item">
    ...
    policy: `<div class="popUp">
          <div class="popUp__wrapper">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">2. Основные понятия, используемые в&nbsp;Политике</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">3. Основные права и&nbsp;обязанности Оператора</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              ...
              <ul class="popUp__items">
                <li class="popUp__item">5.1. Фамилия, имя, отчество.</li>
                <li class="popUp__item">5.2. Электронный адрес.</li>
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">6. Принципы обработки персональных данных</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">7. Цели обработки персональных данных</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">9. Условия обработки персональных данных</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">12. Трансграничная передача персональных данных</div>
              <ul class="popUp__items">
                <li class="popUp__item">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">13. Конфиденциальность персональных данных</div>
              <div class="popUp__descr">
            ...
            <div class="popUp__paragraph">
              <div class="popUp__title">14. Заключительные положения</div>
              <ul class="popUp__items">
                <li class="popUp__item">
